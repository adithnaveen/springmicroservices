...
/*
import com.login.authenticate.controller.AccountController;
import com.login.authenticate.entities.UserSocial;
import com.login.authenticate.services.UserServiceSocial;
...
/*
	...
	@MockBean
	private UserServiceSocial userService;
	
	String exmapleUser = "{\"userName\":\"user\",\"password\":\"my pass\",\"fullName\":\"my fullName\"}";
	@Test
	public void registerTest() throws Exception {
		UserSocial mockUser = new UserSocial("my userName","my password","my fullName");
		

		// userService.save to respond back with mockUser
		Mockito.when(userService.save(Mockito.any(UserSocial.class))).thenReturn(mockUser);
